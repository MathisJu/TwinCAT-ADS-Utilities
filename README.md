...
### Built With
* [Beckhoff.TwinCAT.Ads](https://www.nuget.org/packages/Beckhoff.TwinCAT.Ads/)
...
- [ ] Add support for ADS sub-routes 
- [ ] Add support for ADS over MQTT
- [ ] Add support for secure ADS (tricky)
- [ ] Add further functions for device manager access
- [ ] Add unit tests
